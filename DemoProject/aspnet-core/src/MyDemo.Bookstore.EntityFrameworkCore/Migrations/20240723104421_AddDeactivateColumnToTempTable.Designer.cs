...
namespace MyDemo.BookStore.Migrations
{
    ...
    [Migration("20240723104421_AddDeactivateColumnToTempTable")]
    partial class AddDeactivateColumnToTempTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyDemo.BookStore.Authors.Author", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("MyDemo.BookStore.Books.TempEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("KindOfFalName")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("AppTemp", (string)null);
                });

            modelBuilder.Entity("MyDemo.BookStore.Categories.SystemCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MyDemo.BookStore.Currencies.Currency", b =>
                {
                    b.HasBaseType("MyDemo.BookStore.Categories.SystemCategory");
            ...
            modelBuilder.Entity("MyDemo.BookStore.Departments.Department", b =>
                {
                    b.HasBaseType("MyDemo.BookStore.Categories.SystemCategory");
            ...
            modelBuilder.Entity("MyDemo.BookStore.ExpenseCodes.ExpenseCode", b =>
                {
                    b.HasBaseType("MyDemo.BookStore.Categories.SystemCategory");
            ...
            modelBuilder.Entity("MyDemo.BookStore.KindOfFals.KindOfFal", b =>
                {
                    b.HasBaseType("MyDemo.BookStore.Categories.SystemCategory");
            ...
            modelBuilder.Entity("MyDemo.BookStore.LegalEntities.LegalEntity", b =>
                {
                    b.HasBaseType("MyDemo.BookStore.Categories.SystemCategory");
            ...
            modelBuilder.Entity("MyDemo.BookStore.Vats.Vat", b =>
                {
                    b.HasBaseType("MyDemo.BookStore.Categories.SystemCategory");
            ...
            modelBuilder.Entity("MyDemo.BookStore.Books.Book", b =>
                {
                    b.HasOne("MyDemo.BookStore.Authors.Author", null)
                        .WithMany()
